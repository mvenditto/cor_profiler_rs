...
pub type IHostControl;
pub type ICLRControl;
...
pub trait ICLRRuntimeHost: IUnknown {
    ...
    unsafe fn execute_application(&self, pwz_app_full_name: LPCWSTR, dw_manifest_paths: DWORD, ppwz_manifest_paths: *mut LPCWSTR, dw_activation_data: DWORD, ppwz_activation_data: *mut LPCWSTR, p_return_value: *mut int) -> HRESULT;
