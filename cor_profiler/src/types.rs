...
pub type HMODULE = minwindef::HMODULE;
...
pub type LPVOID = minwindef::LPVOID;
pub type LPCSTR = ntdef::LPCSTR;
pub type LPWSTR = ntdef::LPWSTR;
pub type LPCWSTR = ntdef::LPCWSTR;
pub type ULONG = ntdef::ULONG;
pub type ULONGLONG = ntdef::ULONGLONG;
pub type UINT = minwindef::UINT;
pub type INT_PTR = basetsd::INT_PTR;
...
pub const CLDB_E_RECORD_NOTFOUND: HRESULT = 0x80131130i64 as HRESULT;
